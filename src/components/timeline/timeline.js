...
const Timeline = ({ className }) => {
  return (
    <div className={className}>
      ...
      <br />
      <h1>Education</h1>
      {siteConfig.educations &&
        siteConfig.educations.map(education => (
          <article
            key={education.begin.month + education.begin.year}
            className="timeline__item"
          >
            <div className="inner">
              <span className="timeline__date">
                <span className="timeline__month">{education.begin.month}</span>
                <span className="timeline__year">{education.begin.year}</span>
              </span>
              <h2 className="timeline__title">
                {education.occupation} at {education.company} <br />
                <small className="timeline__title--small">
